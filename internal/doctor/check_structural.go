...
// checkShaAsRef emits CategorySHAAsRef for any uses: ref that is a bare
...
// checkRefChanged emits CategoryRefChanged when the workflow's uses: ref
...
// checkStale emits CategoryStale for lockfile dep entries that no uses:
